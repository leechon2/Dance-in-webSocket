...
\
		...
		<div class="w3l-breadcrumb py-lg-5">
			<div class="container pt-4 pb-sm-4 ServicesPageBanner">
				...
				<ul class="breadcrumbs-custom-path AllBreadcrumbs">
					<a href="${pageContext.request.contextPath }/" rel="nofollow">Home</a>&nbsp;&nbsp;&#187;&nbsp;&nbsp;BookMark
					Page
				</ul>
			</div>
		</div>
	...
	<section class="w3l-team-61 py-5" id="team">
		<div class="container py-lg-5 py-md-4 py-2 LandingPageTeam">
			...
			<button type="button" class="btn btn-primary"
				onclick="searchBookMark('${sessionScope.loginId}')">조회</button>

			<h3 class="title-style mb-lg-5 mb-4 text-center">
				<span></span> BookMark List
			</h3>
    ...
    function searchBookMark(startId) {
    		...
    		success: function (res) {
			    ...
			    for(let bookmark of res) {
			        ...
			        newTeamTitle.className = 'team-title p-4';
			      	...
			      	let buttonBookMarkDelete = document.createElement('button');
			      	buttonBookMarkDelete.className = 'btn btn-primary';
			      	buttonBookMarkDelete.innerText="찜 삭제";
			      	buttonBookMarkDelete.addEventListener('click', function(){
			      		BookMarkDeleteClick(startId,bookmark.id,newcolEl);
			     	});
			        // h5 요소 생성 및 설정
			        ...
			        nickNameSpan.textContent = bookmark.nickname;

			        // star span 요소 생성 및 설정
			        let starSpan = document.createElement('span');
			        starSpan.className = 'star'; // 클래스로 변경
			        let result ="";
			        for(let idx = 0;  idx < Number(bookmark.mbtiresult); idx++){
			        	result +="♥";
			        }
			        ...
			        newTeamTitle.appendChild(buttonBookMarkDelete);
			    
			        
			        let imga = document.createElement('img');
			        imga.src = `resources/profileimg/\${bookmark.userimg}`; 
    ...
    function BookMarkDeleteClick(startId,userId,elObj) {
    	
    	$.ajax({
    		url:'BookMarkDeleteClick',
    		type:'post',
    		data : {
				'userId' : userId,
				'startId' :startId,
