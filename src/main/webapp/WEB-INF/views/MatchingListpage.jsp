...
<body id="top-gap-fixed-header"
	...
	<section class="w3l-team-61 py-5" id="team">
		<div class="container py-lg-5 py-md-4 py-2 LandingPageTeam">
			...
			<button type="button" class="btn btn-primary"
				onclick="searchMathcing('${sessionScope.loginId}')">조회</button>

			<h3 class="title-style mb-lg-5 mb-4 text-center">
				<span></span> Matching List
			</h3>
	...
	<script>
      function changeSelect(obj) {
        console.log("matching" + obj.value);
        return false;
      }
    </script>
	<script type="text/javascript">
	   function searchMathcing(startId) {
	    		...
	    		success: function (res) {
				    ...
				    for(let matching of res) {
				        ...
				        newTeamTitle.className = 'team-title p-4';
				      	...
				      	buttonMatchingDelete.innerText="매칭 취소";
