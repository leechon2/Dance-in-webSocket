...
public class MemberDto {
	...
	private MultipartFile user_imgfiles[];
	...
	public void setUser_personality(String user_personality) {
	...
	public MultipartFile[] getUser_imgfiles() {
		return user_imgfiles;
	}
	public void setUser_imgfiles(MultipartFile[] user_imgfiles) {
	...
	public String toString() {
		return "MemberDto [user_id=" + user_id + ", user_name=" + user_name + ", user_pw=" + user_pw + ", user_birth="
				...
				+ user_weight + ", user_img=" + user_img + ", user_hobby=" + user_hobby + ", user_email=" + user_email
				+ ", user_nickname=" + user_nickname + ", user_phonenumber=" + user_phonenumber + ", user_gender="
				+ user_gender + ", user_idealtype=" + user_idealtype + ", user_pr=" + user_pr + ", user_ps=" + user_ps
				+ ", user_personality=" + user_personality + ", user_regdate=" + user_regdate + ", user_state="
				+ user_state + ", user_imgfiles=" + Arrays.toString(user_imgfiles) + "]";
	}
